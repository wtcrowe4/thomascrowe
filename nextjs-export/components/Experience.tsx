...
const items = [
  {
    ...
    company: "Fastech Services / Calibration Wands",
    ...
    tags: ["React", "Node", "AWS", "LLMs"],
  },
  {
    period: "2019 — 2022",
    role: "Software Engineer",
    company: "Previous Role",
    desc: "Full stack development across web applications. Shipped features end-to-end using React, Node.js, and cloud infrastructure. Started exploring ML integration in production systems.",
